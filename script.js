...
const products = [
    ...
    { 
        ...
        mol: "CaCO₃", purity: ">99%", desc: "A fine white, odorless crystalline powder, Calcium Carbonate is widely used as a diluent and calcium supplement.", 
    ...
    { 
        ...
        mol: "Crosslinked Polyacrylic Acid", purity: ">99%", desc: "A white fluffy hygroscopic powder widely used as a thickening, suspending, and gelling agent.", 
        img: "images/products/excipients/carbomer.jpg",
        features: "High viscosity, Excellent stability", appearance: "White fluffy powder", weight: "Varies", density: "0.20 g/cm³", melting: "Decomposes", origin: "India", moq: "20 Kg", pkgType: "Bag / Drum"
    },
    { 
        ...
        mol: "C₃₆H₇₀CaO₄", purity: ">98%", desc: "A fine white, slightly greasy powder, Calcium Stearate acts as a lubricant and anti-adherent in tablet manufacturing.", 
    ...
    { 
        ...
        mol: "(C₆H₁₁NO₄)n", purity: ">90%", desc: "A natural biopolymer derived from chitin, known for biocompatibility and film-forming properties.", 
        img: "images/products/excipients/chitosan.jpg",
        features: "Biodegradable, Biocompatible", appearance: "Off-white to light cream powder", weight: "Varies", density: "0.75 g/cm³", melting: "Decomposes", origin: "India", moq: "25 Kg", pkgType: "Bag / Drum"
    },
    { 
        ...
        mol: "C₆H₈O₇", purity: ">99%", desc: "A white crystalline organic acid widely used as an acidulant, preservative, and buffering agent.", 
        img: "images/products/excipients/citric-acid.jpg",
        features: "Excellent solubility, pH control", appearance: "White crystalline powder", weight: "192.12 g/mol", density: "1.66 g/cm³", melting: "153°C", origin: "India", moq: "25 Kg", pkgType: "Bag"
    },
    { 
        ...
        mol: "C₈H₁₅NaO₈", purity: ">99%", desc: "A white to cream-colored powder used as a thickener, stabilizer, and binder.", 
    ...
    { 
        ...
        mol: "C₈H₁₆NaO₈", purity: ">99%", desc: "A white powder used as a super disintegrant for rapid drug release.", 
    ...
    { 
        ...
        mol: "(C₆H₉NO)n", purity: ">98%", desc: "Cross-linked Polyvinylpyrrolidone ensures rapid disintegration and faster dissolution.", 
    ...
    { 
        ...
        mol: "CaHPO₄", purity: ">98%", desc: "A filler/diluent providing bulk and enhancing tablet hardness and stability.", 
    ...
    { 
        id: 11, name: "Gelatin", cat: "Excipients", stock: "25 Kg Bag", func: "Gelling Agent", 
        apps: "Hard Capsules, Softgel Capsules", grade: "Pharma Grade / USP / IP", 
        mol: "Protein derivative", purity: ">98%", desc: "A protein-based excipient used as a gelling and capsule-forming agent.", 
    ...
    { 
        ...
        mol: "C₅₆H₁₀₈O₃₀", purity: ">98%", desc: "Semi-synthetic polymer used for binding, film coating, and controlled release.", 
    ...
    { 
        ...
        apps: "Tablets, Capsules", grade: "Pharma Grade / USP / IP", 
        mol: "C₁₂H₂₂O₁₁", purity: ">99%", desc: "Primary diluent and filler offering excellent compressibility.", 
    ...
    { 
        ...
        mol: "(C₆H₁₀O₅)n", purity: ">98%", desc: "Purified cellulose widely used for exceptional compressibility.", 
    ...
    { 
        ...
        mol: "Copolymer", purity: ">98%", desc: "Improves solubility and stability of drugs.", 
    ...
    { 
        ...
        mol: "(C₆H₉NO)n", purity: ">99%", desc: "Synthetic polymer used as a binder and solubilizer.", 
    ...
    { 
        ...
        mol: "C₁₂H₂₅NaO₄S", purity: ">95%", desc: "Wetting, emulsifying, and foaming agent.", 
        img: "images/products/excipients/sls.jpg",
        features: "Excellent foaming, Effective wetting action", appearance: "White to pale yellow powder", weight: "288.38 g/mol", density: "1.01 g/cm³", melting: "204°C", origin: "India", moq: "25 Kg", pkgType: "Bag"
    },
    { 
        id: 21, name: "SSG (Sodium Starch Glycolate)", cat: "Excipients", stock: "25 Kg Bag", func: "Super Disintegrant", 
        apps: "Tablets, Capsules", grade: "Pharma Grade / USP / IP", 
        mol: "C₂₄H₃₅NaO₁₈", purity: ">95%", desc: "Superdisintegrant derived from modified starch.", 
    ...
    { 
        ...
        mol: "C₆H₁₄O₆", purity: ">98%", desc: "Sweet-tasting polyol used as a non-cariogenic sweetener.", 
    ...
    { 
        ...
        mol: "(C₆H₁₀O₅)n", purity: ">98%", desc: "Natural polysaccharide aiding in tablet binding.", 
    ...
    { 
        ...
        mol: "C₁₈H₃₆O₂", purity: ">98%", desc: "Fatty acid used as a lubricant and binder.", 
    ...
    { 
        ...
        mol: "C₁₂H₂₂O₁₁", purity: ">99%", desc: "Primary sweetening and bulking agent.", 
    ...
    { 
        ...
        mol: "Mg₃Si₄O₁₀(OH)₂", purity: ">98%", desc: "Mineral powder used as a lubricant and flow enhancer.", 
    ...
    { 
        ...
        apps: "Tablet Coating, Capsule Coating", grade: "Pharma Grade / IP / BP / USP", 
        mol: "TiO₂", purity: ">99%", desc: "Whitening agent providing brightness and UV protection.", 
    ...
    { 
        ...
        mol: "(C₃₅H₄₉O₂₉)n", purity: ">98%", desc: "Natural polysaccharide produced by fermentation.", 
        img: "images/products/excipients/xanthan-gum.jpg",
        features: "Viscosity control, Stable pH range", appearance: "Cream to off-white powder", weight: "Varies", density: "1.50 g/cm³", melting: "Decomposes", origin: "India", moq: "25 Kg", pkgType: "Bag"
    },
    { 
        ...
        mol: "SiO₂", purity: ">99%", desc: "Fine white powder used as a glidant to improve powder flow.", 
        img: "images/products/excipients/colloidal-silicon-dioxide.jpg",
        features: "Improves powder flow, High adsorption", appearance: "Fine white powder", weight: "60.08 g/mol", density: "2.20 g/cm³", melting: "1600°C", origin: "India", moq: "10 Kg", pkgType: "Bag"
    },
    { 
        ...
        mol: "C₂₀H₃₈O₁₁", purity: ">98%", desc: "Used for sustained drug release and barrier coating.", 
        img: "images/products/excipients/ethyl-cellulose.jpg",
        features: "Water-insoluble, Film strength", appearance: "White granular powder", weight: "Varies", density: "1.14 g/cm³", melting: "240°C", origin: "India", moq: "25 Kg", pkgType: "Bag"
    },
    { 
        ...
        mol: "C₆H₁₄O₆", purity: ">98%", desc: "Non-hygroscopic diluent with a sweet, cooling taste.", 
    ...
    { 
        ...
        mol: "C₈H₈O₃", purity: ">99%", desc: "Antimicrobial preservative effective against bacteria and fungi.", 
    ...
    { 
        ...
        mol: "C₁₀H₁₂O₃", purity: ">99%", desc: "Preservative often used with Methyl Paraben.", 
    ...
    { 
        ...
        mol: "C₇H₅NaO₂", purity: ">99%", desc: "Used to prevent microbial growth and ensure shelf-life.", 
   ...
   // --- COLOURS ---
    ...
    { id: 102, name: "Allura Red Lake", cat: "Colours", stock: "25 Kg", func: "Aluminium Lake", apps: "Tablet Coating, Capsule Coating", grade: "IP/USP/Food Grade", mol: "Complex Aluminium Lake", purity: ">40% Dye Content", desc: "Stable pigment for uniform red coloration.", img: "images/products/colours/allura-red-lake.jpg", type: "Aluminium Lake Pigment", solubility: "Insoluble / Oil Dispersible", density: "0.70 g/cm³", appearance: "Red Fine Powder", features: "Bright colour shade, good heat stability" },
    { id: 103, name: "Black Iron Oxide", cat: "Colours", stock: "25 Kg Bag", func: "Inorganic Pigment", apps: "Capsules, Coatings", grade: "IP/USP", mol: "Fe₃O₄", purity: ">95%", desc: "Used for grey to black shades.", img: "images/products/colours/black-iron-oxide.jpg", ci: "CI 77499", type: "Inorganic Pigment", solubility: "Insoluble", weight: "231.53 g/mol", density: "5.17 g/cm³", appearance: "Black Fine Powder", features: "Deep black shade, high covering power" },
    ...
    { id: 105, name: "Brilliant Blue Lake", cat: "Colours", stock: "25 Kg", func: "Aluminium Lake", apps: "Tablet Coating, Capsule Coating", grade: "IP/USP/Food Grade", mol: "Complex Aluminium Lake", purity: ">35% Dye Content", desc: "Stable blue coloration in coatings.", img: "images/products/colours/brilliant-blue-lake.jpg", type: "Aluminium Lake Pigment", solubility: "Insoluble", weight: "N/A", density: "0.70 g/cm³", appearance: "Blue Fine Powder", features: "High tinting strength, thermal stability" },
    ...
    { id: 107, name: "Carmosine Lake", cat: "Colours", stock: "25 Kg", func: "Aluminium Lake", apps: "Pharmaceutical Coating", grade: "IP/USP/Food Grade", mol: "Complex Aluminium Lake", purity: ">35% Dye Content", desc: "Insoluble pigment form of Carmoisine.", img: "images/products/colours/carmosine-lake.jpg", type: "Aluminium Lake Pigment", solubility: "Insoluble", density: "0.70 g/cm³", appearance: "Dark red Fine Powder", features: "Uniform distribution, light stability" },
    { id: 108, name: "D and C Red 30", cat: "Colours", stock: "25 Kg", func: "Colour Pigment", apps: "Cosmetic, Pharmaceutical", grade: "IP/USP", mol: "C₂₆H₂₂ N₄O₂", purity: ">90%", desc: "Synthetic organic pigment for red coloration.", img: "images/products/colours/d-and-c-red-30.jpg", type: "Organic Pigment", solubility: "Insoluble", weight: "422.48 g/mol", density: "1.30 g/cm³", appearance: "Red Fine Powder", features: "Bright shade, good dispersion" },
    { id: 109, name: "D and C Red 34", cat: "Colours", stock: "25 Kg", func: "Colour Pigment", apps: "Pharmaceutical Coating", grade: "IP/USP", mol: "C₁₈H₁₃N₃NaO₈S", purity: ">90%", desc: "Specialty organic red pigment.", img: "images/products/colours/d-and-c-red-34.jpg", type: "Organic Pigment", solubility: "Insoluble", weight: "454.36 g/mol", density: "1.20 g/cm³", appearance: "Red-violet Fine Powder", features: "High tinting strength, consistent performance" },
    { id: 110, name: "D and C Red 36", cat: "Colours", stock: "25 Kg", func: "Colour Pigment", apps: "Tablet Coating", grade: "IP/USP", mol: "C₂₀H₁₂N₂O₇S₂Na₂", purity: ">90%", desc: "High-performance organic pigment for deep red shades.", img: "images/products/colours/d-and-c-red-36.jpg", type: "Organic Pigment", solubility: "Insoluble", weight: "502.43 g/mol", density: "1.25 g/cm³", appearance: "Bluish-red Fine Powder", features: "Excellent uniformity, high stability" },
    ...
    { id: 123, name: "Yellow Iron Oxide", cat: "Colours", stock: "25 Kg Bag", func: "Inorganic Pigment", apps: "Tablet Coating", grade: "IP/USP", mol: "FeO(OH)", purity: ">95%", desc: "Provides natural yellow tones with light resistance.", img: "images/products/colours/yellow-iron-oxide.jpg", ci: "CI 77492", type: "Inorganic Pigment", solubility: "Insoluble", weight: "88.85 g/mol", density: "4.26 g/cm³", appearance: "Yellow Fine Powder", features: "Natural shade, light resistant" },

    // --- VITAMINS ---
    { id: 201, name: "Ascorbic Acid (Vitamin C)", cat: "Vitamins", stock: "25 Kg Carton", func: "Vitamin / Antioxidant", apps: "Tablets, Capsules, Fortification", grade: "IP/BP/USP/FCC", mol: "C₆H₈O₆", purity: ">99%", desc: "Vital nutrient used to boost immunity.", img: "images/products/vitamins/ascorbic-acid.jpg" },
    ...
    { id: 203, name: "Tocopherol (Vitamin E)", cat: "Vitamins", stock: "Drum", func: "Antioxidant / Nutritive", apps: "Softgels, Topicals, Syrups", grade: "USP/FCC", mol: "C₂₉H₅₀O₂", purity: "Various Strengths", desc: "Protects cell membranes.", img: "images/products/vitamins/tocopherol.jpg" },
    { id: 204, name: "Tocopheryl Acetate", cat: "Vitamins", stock: "Drum", func: "Vitamin E Supplement", apps: "Multi-vitamins, Cosmetics", grade: "USP/IP/EP", mol: "C₃₁H₅₂O₃", purity: ">98%", desc: "Stable ester of Vitamin E.", img: "images/products/vitamins/tocopheryl-acetate.jpg" },
    ...
    { 
        ...
        mol: "C₃H₈O₂", purity: ">99%", desc: "Clear, colorless, viscous liquid used as a solvent and humectant.", 
        img: "images/products/excipients/propylene-glycol.jpg",
        features: "Excellent solvent properties, Moisture retaining", appearance: "Clear colorless viscous liquid", weight: "76.09 g/mol", density: "1.04 g/cm³", melting: "-59°C", origin: "India", moq: "215 Kg", pkgType: "Drum"
    },
    { 
        ...
        mol: "C₃H₈O₃", purity: ">99%", desc: "Clear viscous liquid used as a humectant and sweetener.", 
    ...
    { 
        ...
        mol: "H(OCH₂CH₂)nOH", purity: ">99%", desc: "Versatile polymer used as a plasticizer and solvent.", 
    ...
    { 
        ...
        mol: "C₂H₆O", purity: ">99%", desc: "Clear, colorless, volatile solvent and disinfectant.", 
    ...
    // --- SPECIALTY ---
    { id: 301, name: "Aloe Vera Gel Powder", cat: "Specialty", stock: "10/25 Kg", func: "Natural Extract", apps: "Cosmetics, Nutraceuticals", grade: "Cosmetic / Food Grade", mol: "Natural Extract", purity: "200X / 100X", desc: "Premium extract from Aloe Barbadensis leaf.", img: "images/products/specialty/aloe-vera-gel-powder.jpg" },
    { id: 302, name: "Bio-SAP Polymer", cat: "Specialty", stock: "25 Kg Bag", func: "Water Retainer", apps: "Agriculture, Hygiene, Industrial", grade: "Eco-Friendly", mol: "Bio-Polymer", purity: "High Capacity", desc: "Eco-friendly polymer for massive water retention.", img: "images/products/specialty/bio-based-super-absorbent-polymer.jpg" }
];
...
// 5. MODAL & DETAILS LOGIC (Enhanced font sizes)
...
function submitOrder(method) {
    ...
    if (method === 'whatsapp') {
        ...
        link.href = mailUrl; link.click();
    }
}

// 8. SIDEBAR LOGIC (Bigger Fonts)
